                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @if ($data->role_id !== 1)
                                                @can('read', $data)
                                                    <a href="{{ route('voyager-frontend.account.impersonate', $data->{$data->getKeyName()}) }}" title="{{ __('Act as User') }}" class="btn btn-sm btn-success pull-right" style="margin-right: 5px;">
                                                        <i class="voyager-person"></i> <span class="hidden-xs hidden-sm">{{ __('Act as User') }}</span>
                                                    </a>
                                                @endcan
                                            @endif
                                        </td>
